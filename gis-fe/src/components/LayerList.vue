<template>
  ...
  <div class="layer-list">
    <div
      v-for="(group, groupIndex) in layerData.overlayGroups"
      :key="groupIndex"
    >
      ...
      <h2 @click="toggleCollapse(group)" class="collapsible-heading">
        ...
        <i
          :class="
            group.isCollapsed ? 'fas fa-chevron-down' : 'fas fa-chevron-up'
          "
        ></i>
      </h2>
